class MembersController < ApplicationController
  ...
  private
    ...
    def member_params
      params.require(:member).permit(:cedula, :name, :sur_name, :member_birthdate, :relationship, :phone_number, {social_aid_ids: []}, :head_id, :member_disability, :member_disability_types)
    end
end
